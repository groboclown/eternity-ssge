...
import net.groboclown.essge.game.UnityEngine.GameObject;
...
public class AbilityMod {
    ...
    public enum AbilityModType {
        AdditionalUse, AddAbilityStatusEffects, AddAttackStatusEffects, AttackAccuracyBonus, WoundThresholdAdjustment, NegativeReligiousTraitMultiplier, FinishingBlowDamagePercentAdjustment, AttackDTBypass, AttackSpeedMultiplier, ReplaceParticleFX, AddAttackStatusEffectOnCasterOnly
    }
