...
public class StrongholdAdventure {
    ...
    public enum Type {
        None, Minor, Average, Major, Grand, Legendary, Count
    }

    public enum RewardType {
        XP, Copper, MinorItem, AverageItem, MajorItem, GrandItem, MinorRepBonus, AverageRepBonus, MajorRepBonus, GrandRepBonus, SpecificItem
    }
}
