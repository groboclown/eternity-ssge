...
public class StrongholdEvent {
    ...
    public enum Type {
        CollectTaxes, SpawnAdventure, BuildUpgrade, SpawnIngredients, PayHirelings, RandomEvent, Kidnapped, Escorting, SupplicantEffectsWearOff, Attack, VisitorKilled, Count
    }
}
